...
function ge() {
  ...
  if (o.version = "2.5.8", o.removed = [], !n || !n.document || n.document.nodeType !== 9)
  ...
  var Ue = function(t) {
    ...
    for (L("beforeSanitizeShadowDOM", r, null); e = c.nextNode(); )
      L("uponSanitizeShadowNode", e, null), re(e), ie(e), e.content instanceof f && t(e.content);
  ...
  return o.sanitize = function(t) {
    ...
    e && vt && F(e.firstChild);
    for (var x = ne(q ? t : e); s = x.nextNode(); )
      s.nodeType === 3 && s === N || (re(s), ie(s), s.content instanceof f && He(s.content), N = s);
    if (N = null, q)
      return t;
    if (z) {
      if (J)
...
//# sourceMappingURL=purify.es-CKk_t3XZ-DjG8hwOo.js.map
